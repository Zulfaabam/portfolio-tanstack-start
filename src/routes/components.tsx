        ...
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:gap-6'>
          <div className='relative flex h-[260px] items-center justify-center overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900'>
            <button className='h-9.5 text-text group relative cursor-pointer gap-1.5 rounded-none border-transparent px-3.5 text-xs font-medium hover:bg-transparent sm:text-sm'>
              ...
              />
              {/* Top border */}
              <span className='bg-text/22 group-hover:bg-foreground/30 absolute -left-[6px] -right-[6px] top-0 h-px transition-colors' />
              {/* Bottom border */}
              <span className='bg-text/22 group-hover:bg-foreground/30 absolute -left-[6px] -right-[6px] bottom-0 h-px transition-colors' />
              {/* Left border */}
              <span className='bg-text/22 group-hover:bg-foreground/30 absolute -bottom-[6px] -top-[6px] left-0 w-px transition-colors' />
              {/* Right border */}
              <span className='bg-text/22 group-hover:bg-foreground/30 absolute -bottom-[6px] -top-[6px] right-0 w-px transition-colors' />
