...
export default function BorderMagicBtn({
  ...
  return (
    <button
      className='group relative inline-flex h-10 overflow-hidden rounded-full p-px focus:outline-none md:h-12'
      onClick={onClick}
    >
      ...
      <span className='bg-dark text-fg inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full px-6 py-1 text-lg font-light backdrop-blur-3xl md:px-10 md:text-2xl'>
        {text}
      </span>
    </button>
  );
